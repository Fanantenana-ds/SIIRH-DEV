# # app/schema/discipline .py
# from pydantic import BaseModel
# from typing import List, Optional
# from datetime import date

# # -----------------------------
# # Schemas déjà existants pour Discipline
# # -----------------------------
...
#     case_type: str = "Général"  # <--- default value mba tsy hiteraka error
...
#     compte_rendu: Optional[str] = None
#     employee_name: Optional[str] = None
#     files: Optional[List[Dict[str, str]]] = None  # Pour compatibilité avec le frontend
