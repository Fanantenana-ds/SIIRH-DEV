...
#     # JSON fields
#     new_offre.set_tech_skills(offre_data.tech_skills or [])
#     new_offre.set_soft_skills(offre_data.soft_skills or [])
#     new_offre.set_langs_lvl(offre_data.langs_lvl or {})

#     # scoring_criteres par défaut
#     new_offre.scoring_criteres = offre_data.scoring_criteres or {
...
#             for s in (o.get_tech_skills() or [])
#         ]

#         o.soft_skills = [
#             s["name"] if isinstance(s, dict) and "name" in s else s
#             for s in (o.get_soft_skills() or [])
#         ]

#         o.langs_lvl = o.get_langs_lvl() or {}

#         if isinstance(o.creation_date, datetime):
#             o.creation_date = o.creation_date.date()
